...
GROUP_HELP_TEXT = (
    "🐸 <b>Трейв — помощник для поездок</b>\n\n"
    "Я умею считать расходы, помогать с балансом и отвечать "
    "на тревел-вопросы обычным текстом.\n\n"
    "<b>Быстрый старт:</b>\n"
    "1. Добавь меня в групповой чат\n"
    "2. Создай поездку: <code>/newtrip</code>\n"
    "3. Участники нажимают <code>/join</code>\n"
    "4. Пиши расходы или вопросы обычным сообщением\n\n"
    "<b>Примеры расходов:</b>\n"
    "Трейв, 500 рублей такси\n"
    "Трейв, 1200 TRY ужин на всех\n"
    "Трейв, я оплатил кофе 500\n"
    "Трейв, 300 евро музей с Антоном и Машей\n\n"
    "<b>Можно спрашивать:</b>\n"
    "Трейв, какая погода завтра в Стамбуле?\n"
    "Трейв, сколько денег взять на 3 дня?\n"
    "Трейв, что посмотреть рядом?\n"
    "Трейв, помоги спланировать день\n\n"
    "<b>Команды:</b>\n"
    "/balance — кто кому должен\n"
    "/members — участники поездки\n"
    "/app — история, аналитика и расходы\n"
    "/help — помощь"
)


PRIVATE_HELP_TEXT = GROUP_HELP_TEXT
